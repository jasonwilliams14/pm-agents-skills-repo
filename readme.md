...
│   ├── docs-agent/             # Technical documentation generation
│   ├── f5-product-strategy/      # F5 product positioning and strategy
│   ├── f5xc-patterns/          # F5 Distributed Cloud expertise
...
│   ├── k8s-sme/                # Kubernetes networking and Gateway API
│   ├── nginx-patterns/         # NGINX configuration and optimization
│   ├── observability-ops/      # OpenTelemetry, Prometheus, Grafana workflows
│   ├── obsidian-*              # Obsidian knowledge management tools
